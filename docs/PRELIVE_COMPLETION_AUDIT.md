...
| CI and PR | Draft PR #6; branch head `b5fecc917a246e0f2edaff144e6dbffafa3af78a`; exact-head CI pending re-run after planner cross-platform fix | Local checkpoint evidence |
