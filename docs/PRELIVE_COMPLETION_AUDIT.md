...
| CI and PR | Draft PR #6; branch head `48fb117154dfaf3395d4e39e2332a9302f17c322`; latest exact-head CI success at `29254646967` (push CI run `29254646967`) and `29254649479` (PR CI run `29254649479`) | Local checkpoint evidence |
