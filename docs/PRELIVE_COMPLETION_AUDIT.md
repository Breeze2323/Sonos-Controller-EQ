...
| CI and PR | Draft PR #6; branch head `bfdd2674cf2514c51498759b94174425cc9cb7e2`; latest exact-head CI success at `29255163125` (push CI run `29255163125`) and `29255166382` (PR CI run `29255166382`) | Local checkpoint evidence |
