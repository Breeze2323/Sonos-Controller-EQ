...
| CI and PR | Draft PR #6; branch head `ef81bf17629989349efcb5ba972b5df9e2f9bd28`; exact-head CI success on Node matrix at `29251469180` (push CI run `29251466064`) | Local checkpoint evidence |
