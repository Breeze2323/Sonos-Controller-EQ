...
| CI and PR | Draft PR #6; branch head `aed4666b2c8bb74bf878c079c288cefa3d381bb3`; latest exact-head CI success for this head is green (latest push/PR runs) | Local checkpoint evidence |
