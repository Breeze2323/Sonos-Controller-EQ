...
| CI and PR | Draft PR #6; branch head `53ff2965aab0ad6285030b01b18844ca52f96aaf`; latest exact-head CI success at `29255331526` (push CI run `29255331526`) and `29255335975` (PR CI run `29255335975`) | Local checkpoint evidence |
